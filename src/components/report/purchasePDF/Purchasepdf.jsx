            ...
            <tbody>
              {props.data.map((item, index) => (
                <tr className="bg-white border-b " key={index}>
                  ...
                  <td className="px-6 py-4">{item.purchase_prefix_no}</td>
                  <td className="px-6 py-4"> {item.purchase_name}</td>
                  <td className="px-6 py-4">{item.purchase_amt_type}</td>
                  <td className="px-6 py-4">
                    ₹ {parseFloat(item.purchase_amt).toFixed(2)}
                  </td>
                  <td className="px-6 py-4">
                    ₹ {parseFloat(item.purchase_amt_due).toFixed(2)}
                  </td>
                </tr>
              ))}
            </tbody>
